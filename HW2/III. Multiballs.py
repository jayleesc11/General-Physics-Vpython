...
# constant
size = 0.05 # ball radius
L, k = 0.5, [15, 12, 17] # springs force constant and length
v = [1, 2, 2.2] # balls initial velocity
d = [-0.06, 0, -0.1] # balls position
...
for i in range(3):
    ...
    spring.k = k[i]
    springs.append(spring) # add new spring to the "spring" list